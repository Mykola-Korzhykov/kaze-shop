export const USER_WITH_THIS_EMAIL_NOT_EXIST =
  'User with this email doesn`t exist';
export const USER_WITH_EMAIL_NOT_FOUND = 'User with this email not found!';
export const ERORR_WHILE_SENDING_EMAIL =
  'Unexcpected error occur while sending emails';
export const TROUBLE_SIGNING = {
