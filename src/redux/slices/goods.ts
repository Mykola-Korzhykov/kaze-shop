...
const initialState: GoodsSlice = {
	...
	fetchedColours: [ { label: 'Бежевый', hex: '#FFE4C4', id: 1, type: 'colour' , ru: 'ru', rs: 'rs', en: 'en', ua: 'ua', createdAt: 'stringstringTest', updatedAt: 'stringTest' },
    { label: 'Капучинный', hex: '#9F8E84', id: 2 , type: 'colour' , ru: 'ru', rs: 'rs', en: 'en', ua: 'ua' , createdAt: 'stringstringTest', updatedAt: 'stringTest'},
    { label: 'Синий', hex: '#000080', id: 3  , type: 'colour' , ru: 'ru', rs: 'rs', en: 'en', ua: 'ua' , createdAt: 'stringstringTest', updatedAt: 'stringTest'},
    { label: 'Голубой', hex: '#A6BEE5', id: 4  , type: 'colour' , ru: 'ru', rs: 'rs', en: 'en', ua: 'ua' , createdAt: 'stringstringTest', updatedAt: 'stringTest'},
    { label: 'Коричневый', hex: '#0B0B0B', id: 5  , type: 'colour' , ru: 'ru', rs: 'rs', en: 'en', ua: 'ua' , createdAt: 'stringstringTest', updatedAt: 'stringTest'},
    { label: 'Изумрудный', hex: '#24514C', id: 6  , type: 'colour' , ru: 'ru', rs: 'rs', en: 'en', ua: 'ua' , createdAt: 'stringstringTest', updatedAt: 'stringTest'},
    { label: 'Розовый', hex: '#FFC0CB', id: 7  , type: 'colour' , ru: 'ru', rs: 'rs', en: 'en', ua: 'ua' , createdAt: 'stringstringTest', updatedAt: 'stringTest'},
    { label: 'Фиолетовый', hex: '#800080', id: 8  , type: 'colour' , ru: 'ru', rs: 'rs', en: 'en', ua: 'ua' , createdAt: 'stringstringTest', updatedAt: 'stringTest'},
    { label: 'Черный', hex: '#0B0B0B', id: 52  , type: 'colour' , ru: 'ru', rs: 'rs', en: 'en', ua: 'ua' , createdAt: 'stringstringTest', updatedAt: 'stringTest'},
    { label: 'Оливковый', hex: '#829E86', id: 432  , type: 'colour' , ru: 'ru', rs: 'rs', en: 'en', ua: 'ua' , createdAt: 'stringstringTest', updatedAt: 'stringTest'},
    { label: 'Белый', hex: '#fff', id: 34314 , type: 'colour' , ru: 'ru', rs: 'rs', en: 'en', ua: 'ua' , createdAt: 'stringstringTest', updatedAt: 'stringTest'},
