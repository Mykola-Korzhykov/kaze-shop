...
export const ERROR_WHILE_SIGNING_TOKEN = {
...
export const ERROR_WHILE_VALIDATING_TOKEN = {
...
export const ERROR_WHILE_SAVING_TOKEN = {
...
export const ERROR_WHILE_REMOVING_TOKEN = {
