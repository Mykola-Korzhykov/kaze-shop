...
export const PHONENUMBER_VALIDATION =
  'Phone number must be valid. Invalid Phone number. Please try again.';
...
export const OWNERNAME_VALIDATION =
  'OWNER name must be valid. Invalid OWNERname. Please try again.';
...
export const OWNER_ID_NOT_PROVIDED = {
...
export const OWNER_OR_ROLE_NOT_FOUND = {
...
export const RESET_TIME_EXPIRED = {
...
export const OWNER_WITH_EMAIL_EXIST = {
...
export const OWNER_WITH_PHONENUMBER_EXIST = {
...
export const OWNER_WITH_EMAIL_DOESNT_EXIST = {
...
export const OWNER_WITH_EMAIL_NOT_FOUND = {
