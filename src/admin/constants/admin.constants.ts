...
export const ADMINNAME_VALIDATION =
  'ADMIN name must be valid. Invalid ADMINname. Please try again.';
...
export const ADMIN_ID_NOT_PROVIDED = {
...
export const ADMIN_OR_ROLE_NOT_FOUND = {
...
export const ADMIN_WITH_EMAIL_EXIST = {
...
export const ADMIN_WITH_PHONENUMBER_EXIST = {
...
export const ADMIN_WITH_EMAIL_DOESNT_EXIST = {
...
export const ADMIN_WITH_EMAIL_NOT_FOUND = {
...
export const PHONENUMBER_VALIDATION = 'Provided phoneNumber is incorrect!';
