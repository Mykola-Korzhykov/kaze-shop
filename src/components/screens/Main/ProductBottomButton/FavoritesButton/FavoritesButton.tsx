...
import { FavoritesButtonProps } from './FavoritesButton.interface';
import cn from 'classnames';

const FavoritesButton = ({ onClick, className }: FavoritesButtonProps): JSX.Element => {
    return (
        <button className={cn(s.favorite_button, className)} onClick={onClick}>
