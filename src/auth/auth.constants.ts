...
export const PHONE_NUMRER_VALIDATION =
  'Phone number must be 13 characters long. Invalid phone number. Please try again.';
export const EMAIL_VALIDATION =
  'Email must be valid. Invalid email address. Please try again.';
export const USERNAME_VALIDATION =
  'User name must be valid. Invalid username. Please try again.';
export const SURNAME_VALIDATION =
  'User surname must be valid. Invalid username. Please try again.';
export const USER_WITH_EMAIL_EXIST =
  'User with this email already exist, pick different one.';
export const USER_WITH_PHONENUMBER_EXIST =
  'User with this phone number already exist, pick different one.';
export const USER_WITH_EMAIL_DOESNT_EXIST =
  'User with this email doesn`t exist, pick different one.';
export const INVALID_EMAIL_OR_PASSWORD = 'Invalid entered email or password';
export const ACCESS_DENIED = 'You cannot access this!';
export const NO_TOKEN_PROVIDED = 'No access token provided!';
export const ACTIVATION_EXPIRED = {
...
export const ADMIN_NOT_AUTHORIZIED = {
...
export const OWNER_NOT_AUTHORIZIED = {
...
export const REFRESH_TOKEN_NOT_PROVIDED = {
...
export const EMAIL_NOT_PROVIDED = {
...
export const ACTIVTING_PARAMS_NOT_PROVIDED = {
