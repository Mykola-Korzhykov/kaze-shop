...
const _1 = __importDefault(__webpack_require__(Object(function webpackMissingModule() { var e = new Error("Cannot find module ''"); e.code = 'MODULE_NOT_FOUND'; throw e; }())));
    ...
    getLocation(request, response, next) {
        (() => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const data = yield _1.default.get(`${process.env.CURRENCIES_URL.trim()}/latest?base=${process.env.BASE_CURRENCY.trim()}`, {
                    headers: {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("8e788b9eb5bb68d6e5e0")
/******/ })();
/******/ 
/******/ }
;