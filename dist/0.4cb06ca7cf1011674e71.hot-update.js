    ...
    createProduct(createProductDto, userId, type, images, sizeChartImage) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                console.log(product.categories, 'this');
                ...
                console.log(product.categories, product.colours, 'this');
                if (type && type === 'OWNER') {
                ...
                console.log(product, dbProduct.getCategories(), dbProduct.getColours());
                const Product = {
                    id: product.id,
                    title: product.getTitle(),
                    description: product.getDescription(),
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("403d4b743318b33edde3")
/******/ })();
/******/ 
/******/ }
;