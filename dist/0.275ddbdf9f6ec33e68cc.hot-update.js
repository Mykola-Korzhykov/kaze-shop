...
let ProductController = class ProductController {
    ...
    getProductsByCategory(response, request, next, page, pageSize) {
        (() => __awaiter(this, void 0, void 0, function* () {
            return this.productService.getProductsByCategory(request, response, next, page, pageSize);
        }))();
    }
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("949675bbda9bdb4971ca")
/******/ })();
/******/ 
/******/ }
;